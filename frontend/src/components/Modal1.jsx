...
const Modal1 = (props) => {
  ...
  return (
    ...
    >
      ...
      <Modal.Body className="bg-gray-100 fill-transparent m-0 p-0">
        <div className="max-w-md mx-auto bg-gray-900 text-white p-6 rounded-xl shadow-md border border-gray-700 ">
